...
/**
 * Class which handles exporting of shapefiles to KML. Implements java.lang.Runnable.
 * @author Michael Fotiadis
 *
 */
public class ProcessorKMLExporter implements ExporterInterface, Runnable {
	...
	/**
	 * Initialises the KML Exporter
	 * @param kmlFile Export destination Fifle
	 * @param shapefileContainer ShapefileContainer object (collection) containing data to be exported
	 * @param sourceCRS Original ErgoReferenceSystem of the ShapefileContainer
	 */
	public ProcessorKMLExporter(final File kmlFile, final ShapefileContainer shapefileContainer,
