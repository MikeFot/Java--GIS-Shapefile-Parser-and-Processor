...
public class ExportKML {
	 ...
	 */
	public static void createKML(Collection<ErgoPolyline> GEOMETRY_COLLECTION, ErgoReferenceSystem sourceCRS) {
		Log.Out("Starting KML export..." , 0 , true);
		final Kml mKML = new Kml();
		final String geometry = ParseShapefile.getGEOMETRY_TYPE();
		...
		for (ErgoPolyline currentPolyline : GEOMETRY_COLLECTION) {
	 ...
	 */
	private static void addExtendedData(String[] mArray,
			ErgoPolyline mPolyline, ExtendedData mData) {
